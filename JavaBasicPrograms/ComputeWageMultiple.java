public class ComputeWageMultiple
{
...
//	public static final int MAX_HRS_IN_MONTH=100;
	...
	public static int computeWage(final Company company)
	{
...
//		System.out.println("Total employee wage::" + totalEmpWage);
	...
	public static void main(String args[])
	{
		...
		final int totalWageApple = computeWage(apple);
		System.out.println("Total wage for "+ apple.getName() + "::"+ totalWageApple);
		//for samsung
		final Company samsung = new Company("Samsung", 30, 30, 200);
		final int totalWageSamsung = computeWage(samsung);
                System.out.println("Total wage for "+samsung.getName() + "::"+ totalWageSamsung);
