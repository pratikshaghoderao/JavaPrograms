...
public class ComputeWageObjectUC13 implements IComputeWage
{
	...
	{
		//final Company company = companyList.get(company);
		return 1;
	...
	{
		IComputeWage icw = new ComputeWageObjectUC13();
		//for apple
